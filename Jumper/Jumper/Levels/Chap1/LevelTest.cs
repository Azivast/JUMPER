...
namespace Jumper
{
    static class C1LevelTest
    {
        // Position of player
        public static Vector2 PlayerPoisition = new Vector2(775, 380);
        public static float LevelTime = 999999;
        ...
        public static void LoadContent(ContentManager Content, GraphicsDevice GraphicsDevice)
        {
            ...
            tileManager.AddTile(block, new Vector2(225, 230), new Rectangle(0, 0, 25, 25));
            tileManager.AddTile(block, new Vector2(200, 230), new Rectangle(0, 0, 25, 25));
            tileManager.AddTile(block, new Vector2(175, 230), new Rectangle(0, 0, 25, 25));

            tileManager.AddTile(block, new Vector2(150, 330), new Rectangle(0, 0, 25, 25));
            tileManager.AddTile(block, new Vector2(125, 330), new Rectangle(0, 0, 25, 25));
            tileManager.AddTile(block, new Vector2(100, 330), new Rectangle(0, 0, 25, 25));
